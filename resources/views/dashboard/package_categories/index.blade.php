...
<div class="container">
   <!-- Bordered striped table -->
              ...
              <div class="col-md-6 text-end">
                    <a type="button" href="{{route('package_categories.create')}}"  class="btn btn-outline-success rounded-pill p-2">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-inline-flex">
                            <!-- Edit Action -->
                            <a href="{{ route('package_categories.edit', $category->id) }}" class="text-primary">
                                <i class="ph-pen"></i>
                            </a>
                            <!-- Delete Action -->
                            <form action="{{ route('package_categories.destroy', $category->id) }}" method="POST" class="mx-2">
                                @csrf
                                @method('DELETE')
